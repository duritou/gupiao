...
exports.TERMINAL_CSS = exports.PAGE_TITLES = exports.NAV_ITEMS = exports.BASE_URL = exports.ADAPTIVE_BACKEND_ROOT = exports.INVESTMENT_WORKSPACE_ROOT = exports.ADAPTIVE_API_PORT = exports.ADAPTIVE_API_HOST = void 0;
...
exports.ADAPTIVE_API_HOST = process.env.ADAPTIVE_API_HOST
    || runtime.ADAPTIVE_API_HOST || String(releaseInfo.api_host || '127.0.0.1');
exports.ADAPTIVE_API_PORT = Number(process.env.ADAPTIVE_API_PORT
    || runtime.ADAPTIVE_API_PORT || releaseInfo.api_port || 8888);
exports.INVESTMENT_WORKSPACE_ROOT = process.env.INVESTMENT_WORKSPACE_ROOT
    || runtime.INVESTMENT_WORKSPACE_ROOT || '';
exports.ADAPTIVE_BACKEND_ROOT = process.env.ADAPTIVE_BACKEND_ROOT
    || runtime.ADAPTIVE_BACKEND_ROOT
    || (exports.INVESTMENT_WORKSPACE_ROOT
        ? path.resolve(exports.INVESTMENT_WORKSPACE_ROOT, 'adaptive-investment-intelligence')
        : '');
