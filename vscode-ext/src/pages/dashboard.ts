...
<div class="card">
<h3>AI 建议</h3>
${brief.recommendations.map((r: any) => `
...
async function refreshDashboard() {
    try {
        await fetch('${BASE_URL}/market/overview');
...
startAutoRefresh();`;
    ...
    return pageShell('dashboard', 'Dashboard · 晨报', content, extraScript);
}
