...
${evidence.filter((e: any) => e.icon === 'check').map((e: any) => `
...
${risks.map((r: string) => `<div class="evidence-card warn-card">
...
<div class="card">
<h3>相关新闻</h3>
${news.map((n: any) => `<div class="flex-between" style="padding:10px 0;border-bottom:1px solid #21262d">
