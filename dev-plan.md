...
- [x] 2026-09-13 根治后端反复无响应与无效重启：看门狗单实例锁、SYSTEM 受控重启请求、失败时先释放端口再限速恢复、发布/部署/扩展统一端口配置；专项测试及真实 PID 切换验收通过。证据：`test-reports/unit-20260913-managed-backend-recovery.md`。
