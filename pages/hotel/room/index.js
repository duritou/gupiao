...
Page({
  ...
  // 用户身份由 sessionid/openid 确定，不再用本地 userInfo 门控
  goBuy(e) {
    wx.redirectTo({
      url: `/pages/hotel/buy/index?id=${e.currentTarget.id}&startTime=${this.data.allStartTime}&endTime=${this.data.allEndTime}`
    });
  },
